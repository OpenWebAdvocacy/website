...
### 3.3. Definitions {#3-3-definitions}
...
### 6.2. Maintenance/Development Cost for Multi-Platform Applications {#6-2-maintenance-development-cost-for-multi-platform-applications}
...
### 11.3. Legitimate Issues {#11-3-legitimate-issues}
...
#### 11.3.1. Security {#11-3-1-security}
...
#### 11.3.3. Ignoring User Settings / Preferences {#11-3-3-ignoring-user-settings-preferences}
...
#### 11.3.4. Ignore certain privacy and security policies {#11-3-4-ignore-certain-privacy-and-security-policies}
...
#### 11.3.5. Abandoned Browsers {#11-3-5-abandoned-browsers}
...
#### 11.3.6. Low Effort Spam Browser  {#11-3-6-low-effort-spam-browser}
...
### 11.4. Balancing the need for competition with Security/Privacy {#11-4-balancing-the-need-for-competition-with-security-privacy}
...
### 11.5. REGULATION {#11-5-regulation}
...
2. Not prevent or restrict Third Party Browsers from their choice of a Javascript Engine (for example Nitro, V8) or Layout Engine (for example Blink, Gecko, Webkit)[^2]
...
## 12. Bright Future for Competition {#12-bright-future-for-competition}
...
### 13.1. Alex Russell - Browser Choice Must Matter {#13-1-alex-russell-browser-choice-must-matter}
...
### 13.2. Bruce Lawson {#13-2-bruce-lawson}
...
### 13.3. Stuart Langridge {#13-3-stuart-langridge}
...
Tim Perry - Httptoolkit - On Safari not implementing features with no potential security/privacy issues
...
[^1]:"Usage share of web browsers - Wikipedia." [https://en.wikipedia.org/wiki/Usage_share_of_web_browsers](https://en.wikipedia.org/wiki/Usage_share_of_web_browsers). Accessed 23 Jun. 2021.
[^2]:"A browser engine (also known as a layout engine or rendering engine) is a core software component of every major web browser. The primary job of a browser engine is to transform HTML documents and other resources of a web page into an interactive visual representation on a user's device.
