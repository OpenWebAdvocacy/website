---
title: 'Q&A with Simonetta Vezzoso: The Open Web, Apple, and the DMA'
date: '2026-03-23'
tags:
  - Policy
  - Apple
...
author: OWA
permalink: >-
  /es/blog/question-and-answer-with-simonetta-vezzoso--the-open-web--apple-and-the-dma/index.html
...
> **How does the open web support the goals of the DMA and similar digital regulation regimes around the world in your opinion?**  <br><br>
...
> <cite>[Alex Moore \- Executive Director of OWA](https://www.youtube.com/watch?v=uF2bHOYWdjY)</cite>
...
> **If Apple formally allows alternative web browser engines, but other contractual or technical barriers mean that none have been shipped so far, why hasn't this become a test case for anti-circumvention? In your opinion, what's stopping it?**  <br><br>
...
We outline [our proposals on how Apple can allow browser vendors to update their existing EU users here](https://open-web-advocacy.org/apple-dma-review/#potential-solutions).
...
Last year we argued [in extensive detail why we believe Apple is obligated to fix this under the DMA](https://open-web-advocacy.org/blog/apples-browser-engine-ban-persists-even-under-the-dma/#is-apple-obligated-to-fix-this-under-the-dma%3F).
