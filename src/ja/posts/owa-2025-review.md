...
author:
  - Alex Moore
permalink: /ja/blog/owa-2025-review/index.html
...
* [Join our community of volunteers and supporters on Discord](https://discord.com/invite/x53hkqrRKx) or [contact us via email](mailto:contactus@open-web-advocacy.org).  
* Comment on articles in the media.  
* Talk to your friends and co-workers to spread the word.  
* Keep sharing our campaigns and follow us on [Mastodon](https://mastodon.social/@owa), [Bluesky](https://bsky.app/profile/open-web-advocacy.org), [X/Twitter](https://twitter.com/OpenWebAdvocacy) and [LinkedIn](https://www.linkedin.com/company/open-web-advocacy/).  
...
We aim to allow both browsers and web apps to compete fairly on all operating systems. At the heart of this is ending [Apple’s longstanding ban on third-party browser engines on iOS](https://open-web-advocacy.org/walled-gardens-report/#apple-has-effectively-banned-all-third-party-browsers).
...
* [Apple reversed its decision to remove key web app functionality in the EU](https://open-web-advocacy.org/blog/apple-backs-off-killing-web-apps/)  
* [Apple has been prohibited from banning browser engines in the EU](https://open-web-advocacy.org/apple-dma-review/)  
* [Apple has been prohibited from banning browser engines in Japan](https://open-web-advocacy.org/blog/japan-apple-must-lift-engine-ban-by-december/)  
* [Apple now allows browser vendors to test their own browsers outside the EU](https://open-web-advocacy.org/blog/owa-2024-review/#got-apple-to-let-browser-vendors-test-their-own-browsers)  
* [Apple no longer hides the option to change default browser if Safari is the default](https://open-web-advocacy.org/blog/owa-2024-review/#made-apple-fix-their-trick-of-hiding-the-default-browser-option-if-safari-was-the-default)  
* [Apple has implemented push notifications for iOS Safari](https://open-web-advocacy.org/blog/uk-regulators-final-verdict--apples-browser-engine-ban-harms-competition/#:~:text=Two%20weeks%20later%20\(and%20after%20more%20than%20a%20decade%20of%20refusing%20to%20do%20so\)%2C%20Apple%20quietly%20began%20work%20on%20push%20notifications%20for%20iOS%20Safari.)  
* [Apple has implemented a global defaults page on iOS](https://open-web-advocacy.org/blog/apple-adopts-6-owa-choice-architecture-recommendations/#:~:text=The%20option%20to%20change%20default%20browser%20should%20be%20moved%20out%20of%20the%20browser%20settings%20and%20into%20a%20centralised%20location.)  
* [Apple now globally supports interoperable AirDrop between iOS and Android](https://arstechnica.com/gadgets/2025/11/the-eu-made-apple-adopt-new-wi-fi-standards-and-now-android-can-support-airdrop/)  
* [Apple grants the hotseat to the selected browser in the EU browser choice screen](https://open-web-advocacy.org/blog/owa-2024-review/#secured-hotseat-placement-on-the-eu-choice-screen)
...
> <cite>[Digital Markets Act \- Article 5(7)](https://eur-lex.europa.eu/legal-content/EN/TXT/?toc=OJ%3AL%3A2022%3A265%3ATOC&uri=uriserv%3AOJ.L_.2022.265.01.0001.01.ENG)<br>(emphasis added)</cite>
...
> <cite>[Digital Markets Act  \- Recital 43](https://eur-lex.europa.eu/legal-content/EN/TXT/?toc=OJ%3AL%3A2022%3A265%3ATOC&uri=uriserv%3AOJ.L_.2022.265.01.0001.01.ENG)<br>(emphasis added)</cite>
...
> <cite>[Digital Markets Act \- Article 6(7)](https://eur-lex.europa.eu/legal-content/EN/TXT/?toc=OJ%3AL%3A2022%3A265%3ATOC&uri=uriserv%3AOJ.L_.2022.265.01.0001.01.ENG)<br>(emphasis added)</cite>
...
In June 2024, [we published a detailed analysis on why Apple was not in compliance with the DMA and why it would be difficult for any browser vendor to port under these conditions](https://open-web-advocacy.org/blog/apple-dma-review/).

In June 2025, we followed up with [a paper outlining in detail the exact barriers that Apple had put in place and why their solution was still not in compliance with the DMA](https://open-web-advocacy.org/blog/apples-browser-engine-ban-persists-even-under-the-dma/). We also had the opportunity to [question Apple directly on this at the DMA workshop](https://open-web-advocacy.org/blog/apples-browser-engine-ban-persists-even-under-the-dma/#apple-dma-workshop).
...
> On its website, Apple indicated that it would aim at providing developers **updates every 90 days**.  <br><br>
> It appears from the 108 interoperability requests received by Apple from January 2024 until 31 October 2024,**that the time taken by Apple to process interoperability requests through the different stages is significantly longer than the timelines mentioned in the previous paragraph**.
...
> <cite>[Commission Implementing Decision](https://ec.europa.eu/competition/digital_markets_act/cases/202523/DMA_100203_1655.pdf)</cite>

You can read the [highly detailed specification decision here](https://ec.europa.eu/competition/digital_markets_act/cases/202523/DMA_100203_1655.pdf) and [its update here](https://ec.europa.eu/competition/digital_markets_act/cases/202538/DMA_100203_1809.pdf).

It is this specification proceeding that has led to [globally available support for AirDrop between iOS and Android](https://arstechnica.com/gadgets/2025/11/the-eu-made-apple-adopt-new-wi-fi-standards-and-now-android-can-support-airdrop/).
...
We directly questioned Google on this at the DMA workshop. [Read this article](https://open-web-advocacy.org/blog/googles-hotseat-hypocrisy/) for our full analysis.
...
> <cite>[Google](https://web.dev/webapks/)</cite>
...
[OWA has been pushing for this functionality](https://open-web-advocacy.org/blog/google-must-share-the-ability-to-install-web-apps-in-android/) to be shared in multiple jurisdictions and [published a paper outlining this issue in more detail](https://open-web-advocacy.org/files/OWA%20-%20DMA%20Interventions%20-%20Web%20App%20Install%20on%20Android%20-%20v1.0.pdf). Google is clearly obligated to share this functionality in the EU and Japan.
...
The UK was particularly busy this year with a new law, investigations closing and new ones opening. OWA has worked with the UK’s Competition and Markets Authority (CMA) for the last four years across 3 separate investigations. [You can read a full timeline of our involvement here](https://open-web-advocacy.org/blog/uk-regulators-final-verdict--apples-browser-engine-ban-harms-competition/#timeline-of-events).

**We are incredibly thankful for the hard work and dedication the CMA has shown in pursuing an issue that, while critical to mobile software development, is so densely technical.** Their hard work looks set to finally pay off under the DMCC, which will finally grant the CMA the power to fix the wrongs that both the [mobile ecosystem investigation](https://www.gov.uk/government/publications/mobile-ecosystems-market-study-final-report) and the [mobile browsers and cloud gaming market investigation reference identified](https://open-web-advocacy.org/blog/uk-regulators-final-verdict--apples-browser-engine-ban-harms-competition/).

### DMCC

First the [Digital Markets, Competition, and Consumers Act (DMCC)](https://www.legislation.gov.uk/ukpga/2024/13/enacted/data.xht?view=snippet&wrap=true) came into force on 1st January 2025\. This act grants the UK regulator authority to designate companies with Strategic Market Status (SMS).

This can be thought of as the UK’s equivalent to the EU’s Digital Markets Act, although it has differences in how it is implemented as [covered in this article](https://www.ashurst.com/en/insights/digital-markets-regulation-in-the-eu-and-uk-dma-v-dmcc/#:~:text=In%20recent%20years%2C%20the%20EU%20and%20UK%20have,key%20similarities%20and%20differences%20between%20the%20two%20regimes.). The DMCC mostly leaves it up to the CMA to decide what rules are appropriate to impose; the DMA dictates its rules with significantly less room for flexibility.
...
This year the [UK's Mobile Browsers and Cloud Gaming Market Investigation Reference (MIR) came to a close](https://open-web-advocacy.org/blog/uk-regulators-final-verdict--apples-browser-engine-ban-harms-competition/).

They published its [final report](https://assets.publishing.service.gov.uk/media/67d1abd1a005e6f9841a1d94/Final_decision_report1.pdf) in March. **The conclusion was clear: Apple’s “WebKit restriction”, which forces all browsers on iOS to use Apple’s engine, harms competition, stifles innovation and functionality, particularly for web apps.**
...
The [report](https://assets.publishing.service.gov.uk/media/67d1abd1a005e6f9841a1d94/Final_decision_report1.pdf) (which is more than 600 pages) contains a number of significant conclusions including:

> We conclude that the WebKit restriction means that there is no competition between browser engines on iOS.  <br><br>
...
In January 2025, [the CMA launched such an investigation into both Apple and Google with respect to their mobile ecosystems](https://open-web-advocacy.org/blog/uk-launches-investigation-into-apple-and-google-under-dmcc/). You can read [our response to Apple’s SMS investigation here](https://assets.publishing.service.gov.uk/media/67c820712ecc810ad1fc656c/Open_Web_Advocacy.pdf) and [our response to the proposed decision here](https://assets.publishing.service.gov.uk/media/68c3d27c7596dbfa052bfef1/Open_Web_Advocacy.pdf).

On the 22nd of October 2025, [the CMA formally designated both Apple](https://assets.publishing.service.gov.uk/media/68fb86f430c331c88be6f0cb/Final_decision_report.pdf) [and Google](https://assets.publishing.service.gov.uk/media/68f8bf4780cf98c6e8ed8f83/Final_decision_report.pdf) as having Strategic Market Status. We [analysed in depth what this might mean here](https://open-web-advocacy.org/blog/what-apples-uk-strategic-market-status-designation-means-for-browsers-and-web-apps/).

The [SMS investigation reaffirmed many of the findings of the previous mobile ecosystems and MIR](https://open-web-advocacy.org/blog/what-apples-uk-strategic-market-status-designation-means-for-browsers-and-web-apps/#web-apps-can-not-effectively-compete-on-ios).

[During the SMS investigation, the CMA discussed a number of potential obligations](https://assets.publishing.service.gov.uk/media/67911997cf977e4bf9a2f1aa/Invitation_to_comment.pdf) it may impose on Apple and Google in relation to browsers, browser engines and web apps.  
...
> <cite>[CMA \- SMS Investigation Request for Comment](https://assets.publishing.service.gov.uk/media/67911997cf977e4bf9a2f1aa/Invitation_to_comment.pdf)<br>(emphasis added)</cite>

According to the [CMA’s current roadmap](https://assets.publishing.service.gov.uk/media/687f893cf2ecaeb756d0e1e6/Roadmap__Apple_.pdf), they will be conducting investigations into both *“Requiring Apple to allow third-party browsers and app developers to use alternative browser engines on iOS and iPadOS”* and *“to explore the potential for Progressive web apps”* in the first half of 2026\. We will be reporting more on this as it happens\!
...
While we fully understood the rationale behind prohibiting search engine revenue-sharing agreements and [supported the DOJ's decision to cancel the Apple-Google search deal](https://open-web-advocacy.org/blog/break-googles-search-monopoly-without-breaking-the-web/#should-the-apple-google-search-deal-be-banned%3F), which undermines iOS browser competition and, with a possible 98.5% profit margin, channels only a minimal share of its value into web platform development. However, we were concerned about the unintended consequences this approach may have on smaller browsers, particularly Mozilla. Stripping Google of, at most, an additional 1.15%, and [likely only 0.74%, of U.S. search traffic does not justify the risk of bankrupting a key contributor to the open web ecosystem](https://open-web-advocacy.org/blog/is-it-worth-killing-mozilla-to-shave-off-less-than-1-percent-from-googles-market-share/).

> THE COURT: So I mean, it seems to me Mozilla, in some sense, would have a more compelling argument than you because it's not like Apple is going to go out of business if I don't \-- you know, if you can no longer get revenue share. You've got other sources of revenue; Mozilla hardly has any.
...
[Our concerns were widely shared](https://open-web-advocacy.org/blog/industry-voices-caution-against-dojs-plan-to-force-sale-of-chrome/) by those who work in or rely heavily on the browser technologies.

With this in mind, we wrote an extensive piece that outlined our concerns in exhaustive detail in a piece titled [“Break Google’s Search Monopoly without Breaking the Web”](https://open-web-advocacy.org/blog/break-googles-search-monopoly-without-breaking-the-web/) and met with the DOJ to express our concerns.

We appreciated that the DOJ took these concerns seriously and acknowledged the importance of a viable future for Chromium and the open web in its [Revised Final Judgment Proposal](https://storage.courtlistener.com/recap/gov.uscourts.dcd.223205/gov.uscourts.dcd.223205.1184.1.pdf), which required an evaluation of the buyer’s business and investment plans, including those for the open-source Chromium project. The proposal states:
...
> <cite>[Plaintiffs’ Revised Proposed Final Judgment](https://storage.courtlistener.com/recap/gov.uscourts.dcd.223205/gov.uscourts.dcd.223205.1184.1.pdf)</cite>
*(emphasis added)*
...
Ultimately in September, [Judge Mehta rejected both the DOJ’s ban on browser search engine deals and a forced sale of Chrome](https://storage.courtlistener.com/recap/gov.uscourts.dcd.223205/gov.uscourts.dcd.223205.1436.0_5.pdf). The final remedies were significantly less forceful than both the DOJ’s and our suggested replacements.
...
> <cite>[Judge Mehta](https://storage.courtlistener.com/recap/gov.uscourts.dcd.223205/gov.uscourts.dcd.223205.1436.0_5.pdf)</cite>
...
[Google is reportedly planning to appeal](https://www.reuters.com/technology/what-comes-next-googles-antitrust-case-over-search-2025-09-02/?utm_source=chatgpt.com#:~:text=Google%20has%20said%20it%20plans%20to%20appeal%20%2D%20it%20will%20have%2030%20days%20from%20the%20final%20judgment%20in%20the%20case%20to%20begin%20the%20process.%20The%20appeal%20could%20stretch%20into%202027%20or%20later.) and the DOJ has been silent on the issue but as yet to our knowledge no formal appeal documents have been filed by either party. [The final judgement was entered on the 5th of December 2025](https://storage.courtlistener.com/recap/gov.uscourts.dcd.223205/gov.uscourts.dcd.223205.1436.0_5.pdf). It appears [both parties have 60 days to appeal](https://www.ca11.uscourts.gov/filing-notice-appeal#:~:text=When%20the%20United%20States%20or%20its%20officer%20or%20agency%20is%20a%20party%2C%20the%20notice%20of%20appeal%20may%20be%20filed%20by%20any%20party%20within%2060%20days%20after%20the%20judgment%20or%20order%20appealed%20from%20is%20entered.), meaning the deadline would be 3rd February 2026\.
...
> Apple wraps itself in a cloak of privacy, security, and consumer preferences to  <br><br>
...
One of the reasons that many users on iOS are unaware of how to install web apps is Apple has for years refused to implement install prompts and [hidden away the mechanism for installing them on the share menu](https://open-web-advocacy.org/walled-gardens-report/#ios-web-app-installation---a-well-hidden-safari-exclusive). At the same time, Apple has gone to great lengths to make it easy to link to and install Apple’s on iOS app store native apps from Safari.

The DOJ vs Apple case is slowly working its way through the court system. Currently the case is in the document discovery phase, which [Apple has recently requested an extension till the 15th June 2026 to produce what Apple claims is over 11 million documents](https://www.courtlistener.com/docket/68362334/351/united-states-of-america-v-apple-inc/). This suggests that the actual trial will not start until late 2027\.

## Australia

In 2024, the Australian government agreed to [new competition laws for digital platforms](https://www.accc.gov.au/media-release/consumers-and-small-businesses-to-benefit-from-proposed-new-regulation-of-digital-platforms).  
...
> The code of conduct for mobile OS services could require Designated Digital Platforms to allow third-party browser engines to be used on their mobile OS. This could allow third-party providers of browsers and web apps to compete on their merits.  <br><br>
...
> <cite>[Digital platform Services Inquiry \- Interim Report No. 5](https://www.accc.gov.au/system/files/Digital%20platform%20services%20inquiry%20-%20September%202022%20interim%20report.pdf)</cite>

They conducted a [public consultation in early 2025](https://treasury.gov.au/sites/default/files/2024-12/c2024-547447-pp.pdf). You can read [our response here](/files/OWA%20-%20Australia%20Treasury%20-%20A%20New%20Digital%20Competition%20Regime%20Response%20-%20v1.0.pdf).
...
> A lack of competition in Australia’s digital markets can stifle productivity and innovation, reduce choices, and lead to higher prices for Australian consumers and small businesses.  <br><br>
> **Australians need mandatory codes for the most powerful digital platforms to prevent harms from a lack of competition**  <br><br>
...
> <cite>[Key findings from the Digital Platform Services Inquiry Final Report](https://www.accc.gov.au/system/files/key-findings-from-the-final-report-dpsi-2020-25.pdf)</cite>
...
> <cite>[Digital Platform Services Inquiry Final Report](https://www.accc.gov.au/system/files/digital-platform-services-inquiry-final-report-march2025.pdf)</cite>
...
> <cite>[The Modern Regulator](https://themodernregulator.com/australia-big-tech-competition-regime/)</cite>
...
You can see the [full original interview here](https://youtu.be/78w61I62N_0?t=2457) and [our analysis here](https://open-web-advocacy.org/blog/tim-berners-lee-on-apples-browser-engine-ban-and-web-apps/).

> Do you think that Apple being made to allow Chromium to run on the iPhone, for example, will actually lead to new browser innovation?
> <cite>[Nilay Patel \- The Verge](https://youtu.be/78w61I62N_0?t=2457)</cite>

> **When you have a competition between different sections of the layer, it tends to increase innovation**. You get more bright ideas out there.
...
At the start of the year, [we published a paper outlining how Apple was not in effective compliance with Article 5(7) of the DMA](https://open-web-advocacy.org/blog/apples-browser-engine-ban-persists-even-under-the-dma/). **It is now twenty one months since the DMA came into force, no browser vendor has successfully ported a competing engine to iOS.** The financial, technical, and contractual barriers Apple has put in place remain insurmountable. These restrictions are not grounded in strictly necessary or proportionate security justifications.
