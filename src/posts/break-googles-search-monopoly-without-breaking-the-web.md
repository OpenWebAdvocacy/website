...
Notably, if the new owner were able to sell 50% of its search default placement to Google, this would easily cover all ongoing development, maintenance, and web platform research costs while still generating a healthy profit from other ventures while not contributing to majority market share for Google.
...
While search choice screens do offer some important benefits, they typical only shift a few percentage points of market share, which would be far less impactful than directly reallocating 50% of the default search market to competing providers.
